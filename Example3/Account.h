...
public:
   ...
   Account() {} // Was getting an error saying there was no constructor without parameters, so I added this
   explicit Account(std::string accountName) // New explicit single-parameter constructor
       : name{ accountName } {
